package kz.incubator.mds.reads.book_list_menu;
...
import kz.incubator.mds.reads.book_list_menu.activities.AddBook;
import kz.incubator.mds.reads.book_list_menu.adapters.BookListAdapter;
...
import static kz.incubator.mds.reads.database.StoreDatabase.TABLE_BOOKS;
        ...
        myTopPostsQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(getActivity(), getString(R.string.can_not_booklist_ver), Toast.LENGTH_SHORT).show();
                }
            }
        ...
        booksRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()) {
                    ...
                    bookListAdapter.notifyDataSetChanged();
                    setTitle(getString(R.string.menu_books)+bookList.size());
                }
            }
